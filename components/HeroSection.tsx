  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(255, 135, 39, 0.7), rgba(255, 135, 39, 0.6), rgba(255, 135, 39, 0.7))' }}></div>
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute top-32 right-20 w-6 h-6 bg-orange-300 rounded-full animate-float delay-200"></div>
        <div className="absolute bottom-20 left-1/4 w-3 h-3 bg-orange-400 rounded-full animate-float delay-500"></div>
        <div className="absolute bottom-40 right-1/3 w-5 h-5 bg-orange-400 rounded-full animate-float delay-700"></div>
      </div>
